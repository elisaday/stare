...
class Roster(PlugIn):
    ...
    def PresenceHandler(self,dis,pres):
        ...
        jid_key = jid.getStripped().lower()
        if not self._data.has_key(jid_key): 
            self._data[jid_key]={'name':None,'ask':None,'subscription':'none','groups':['Not in roster'],'resources':{}}

        item=self._data[jid_key]
        typ=pres.getType()
